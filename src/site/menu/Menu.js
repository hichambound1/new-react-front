...
const Menu = () =>{
    ...
    const userstatu = JSON.parse(localStorage.getItem('auth_user')).statu;
    useEffect( ()=>{
        ...
        <div>
            ...
            :
            <div>
                <h3 className='text-capitalize' style={{"position":"absolute","top":"50%","left":"50%","transform":"translate(-50%, -50%)"}}>unfortunately ,your account is blocked ,contact the support to figure out why</h3>
            </div>
            }
        </div>
    );
