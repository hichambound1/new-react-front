        ...
        <div className="about">
                ...
                <div class="col-lg-5">
                    <div class="section-title text-center pb-30">
                        <div class="line m-auto"></div>
                            <h3 class="title"><span>Owr </span>Rules ?</h3>
                        </div>
                    </div>
            </div>
            <section className="container">
                ...
                <ul>
                    <li className="my-3">
                        <span>
                            <i class="fa fa-dot-circle-o  px-2 text-primary" aria-hidden="true"></i>
                        </span>
                    ...
                    <li className="my-3">
                        ...
                        but by far the most useful is the "click here" 
                    </li>
                    <li className="my-3">
                        <span>
                            <i class="fa fa-dot-circle-o  px-2 text-primary" aria-hidden="true"></i>
                    ...
                    <li className="my-3">
                        ...
                        For more ways to use automated website policies, download the guide "Must-have policies for protecting your website".                    </li>
                    <li className="my-3">
                        <span>
                            <i class="fa fa-dot-circle-o  px-2 text-primary" aria-hidden="true"></i>
                        </span>
                    ...
                    <li className="my-3">
                        <span>
                         ...
                         Policy feature we'd still be finding those old references years or even decades later!"
                    </li>
                </ul>
                <h3>Lorem ipsum dolor sit.</h3>
                <ul>
